    ...
    <Layout>
      ...
      <div className="Contact-container">
        <div className="Contact-details">
          <h1>Contact us..</h1>
          <br />
          <h2 style={{ color: mode === 'dark' ? 'white' : '' }}>GUEST SUPPORT AND COFFEE QUESTIONS</h2>
          ...
          <h2 style={{ color: mode === 'dark' ? 'white' : '' }}>BRAND PARTNERSHIP INQUIRIES</h2>
          <a href="mailto:partnerships@example.com">partnerships@example.com</a>
          <h2 style={{ color: mode === 'dark' ? 'white' : '' }}>TRADE SHOW INQUIRIES</h2>
          <a href="mailto:tradeshow@example.com">tradeshow@example.com</a>
          <h2 style={{ color: mode === 'dark' ? 'white' : '' }}>DONATION INQUIRIES</h2>
          <a href="mailto:donations@example.com">donations@example.com</a>
          <h2 style={{ color: mode === 'dark' ? 'white' : '' }}>CORPORATE GIFTING INQUIRIES</h2>
          <a href="mailto:corporategifting@example.com">corporategifting@example.com</a>
        </div>

        <div className="Contact-map">
           {/* Map image with address and phone numbers */}
          <img src={mapImage} alt="Map" />
            <div className="contact-info "style={{ color: mode === 'dark' ? 'white' : '' }}>
              <p>1234 Pet Street</p>
